...
export default function Home() {
  ...
  return <main className="app-shell bg-quest-bg">
    ...
    <nav aria-label="Mobile navigation" className="fixed inset-x-3 bottom-3 z-30 grid grid-cols-5 rounded-2xl border border-white/10 bg-quest-surface/95 p-1 shadow-2xl shadow-black/40 backdrop-blur lg:hidden">
